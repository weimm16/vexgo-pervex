    ...
    >
      ...
      <header className="bg-white dark:bg-dark border-b border-gray-200 dark:border-gray-800 py-4 px-6">
        <div className="container mx-auto flex justify-between items-center">
          <a href="/" className="text-xl font-bold text-primary">我的博客</a>
          <nav>
      ...
      {/* 页脚 */}
      <footer className="bg-gray-50 dark:bg-dark/80 py-6 px-6 text-center text-gray-600 dark:text-gray-400">
        © {new Date().getFullYear()} 我的个人博客 | 基于 VexGo 构建
      </footer>
    </motion.div>
  );
};
